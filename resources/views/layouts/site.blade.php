            ...
            <form class="needs-validation" novalidate>
                <div class="form-row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="userlname" placeholder="Фамилия пользователя" required>
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="userphone" placeholder="Телефон" required>
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                ...
                <button style="margin-top: 10px;" class="btn btn-primary btn-submit" type="submit">Сохранить</button>
...
<script>
    function setResult()
    {
        $.ajax({
            ...
            url: '{{route("usersave")}}',
            cache: false,
            data: "username="+$("#username").val()+"&userlname="+$("#userlname").val()+"&useremail="+$("#useremail").val()+"&userphone="+$("#userphone").val()+"&usertarif="+$("#usertarif").val()+"&usersubscription="+$("#usersubscription").val(),
